...
seq $a0, $a0, $a1
sw $a0, -12($sp)
# IfZ t3 Goto _attempt_bool.263
lw $a0, -12($sp)
beqz $a0, _attempt_bool.263
# PushParam t2;
lw $a0, -8($sp)
sw $a0, -32($sp)
...
sw $v0, -8($sp)
# PopParam 1;
# Goto _not_more_attempt.263
j _not_more_attempt.263
# _attempt_bool.263:
...
seq $a0, $a0, $a1
sw $a0, -12($sp)
# IfZ t3 Goto _attempt_string.263
lw $a0, -12($sp)
beqz $a0, _attempt_string.263
# PushParam t2;
lw $a0, -8($sp)
sw $a0, -32($sp)
...
seq $a0, $a0, $a1
sw $a0, -12($sp)
# IfZ t3 Goto _not_more_attempt.263
lw $a0, -12($sp)
beqz $a0, _not_more_attempt.263
# PushParam t2;
lw $a0, -8($sp)
sw $a0, -32($sp)
