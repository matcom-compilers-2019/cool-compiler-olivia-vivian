...
seq $a0, $a0, $a1
sw $a0, -16($sp)
# IfZ t4 Goto _attempt_bool.158
lw $a0, -16($sp)
beqz $a0, _attempt_bool.158
# PushParam t3;
lw $a0, -12($sp)
sw $a0, -28($sp)
...
sw $v0, -12($sp)
# PopParam 1;
# Goto _not_more_attempt.158
j _not_more_attempt.158
# _attempt_bool.158:
...
seq $a0, $a0, $a1
sw $a0, -16($sp)
# IfZ t4 Goto _attempt_string.158
lw $a0, -16($sp)
beqz $a0, _attempt_string.158
# PushParam t3;
lw $a0, -12($sp)
sw $a0, -28($sp)
...
seq $a0, $a0, $a1
sw $a0, -16($sp)
# IfZ t4 Goto _not_more_attempt.158
lw $a0, -16($sp)
beqz $a0, _not_more_attempt.158
# PushParam t3;
lw $a0, -12($sp)
sw $a0, -28($sp)
...
seq $a0, $a0, $a1
sw $a0, -12($sp)
# IfZ t3 Goto _attempt_bool.212
lw $a0, -12($sp)
beqz $a0, _attempt_bool.212
# PushParam t2;
lw $a0, -8($sp)
sw $a0, -32($sp)
...
sw $v0, -8($sp)
# PopParam 1;
# Goto _not_more_attempt.212
j _not_more_attempt.212
# _attempt_bool.212:
...
seq $a0, $a0, $a1
sw $a0, -12($sp)
# IfZ t3 Goto _attempt_string.212
lw $a0, -12($sp)
beqz $a0, _attempt_string.212
# PushParam t2;
lw $a0, -8($sp)
sw $a0, -32($sp)
...
seq $a0, $a0, $a1
sw $a0, -12($sp)
# IfZ t3 Goto _not_more_attempt.212
lw $a0, -12($sp)
beqz $a0, _not_more_attempt.212
# PushParam t2;
lw $a0, -8($sp)
sw $a0, -32($sp)
